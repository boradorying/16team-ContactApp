...
object ContactsManager {
    ...
    init {
        ...
        val contact6 = Contact("박동이","010-7777-1234", "snoopn@naver.com", null, R.drawable.donge,false,false,false)
        val contact7 = Contact("박뽀시","010-1234-7777", "snoopn@naver.com", null, R.drawable.bbosi,false,false,false)
        val contact8 = Contact("김민수","010-5738-7117", "snoopn@naver.com", null, R.drawable.minsu2,false,false,false)
        val contact9 = Contact("조경화","010-5738-7117", "snoopn@naver.com", null, R.drawable.gyeonghwa2,false,false,false)
        val contact10 = Contact("차승현","010-5738-7117", "snoopn@naver.com", null, R.drawable.seounghyun2,false,false,false)
        val contact11 = Contact("황세준","010-5738-7117", "snoopn@naver.com", null, R.drawable.sejun2,false,false,false)
