...
init {
    ...
    val contact9 = Contact("조경화","010-5738-7117", "snoopn@naver.com",R.drawable.gyeonhwa2,false)
    val contact10 = Contact("황세준","010-5738-7117", "snoopn@naver.com",R.drawable.sejun2,false)
