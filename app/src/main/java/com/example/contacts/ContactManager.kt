...
init {
    ...
    val contact6 = Contact("박동이","010-7777-1234", "jemini@naver.com",R.drawable.donge,false)
    val contact7 = Contact("박뽀시","010-1234-7777", "jemini@naver.com",R.drawable.bbosi,false)
    val contact8 = Contact("김민수","010-7821-7117", "chochoo@naver.com",R.drawable.minsu2,false)
    val contact9 = Contact("조경화","010-6666-6666", "fork@naver.com",R.drawable.gyeonghwa2,false)
    val contact10 = Contact("차승현","010-4444-4444", "tmdgus@naver.com",R.drawable.seounghyun2,false)
    val contact11 = Contact("황세준","010-1111-1111", "dodo@naver.com",R.drawable.sejun2,false)
